...
export const TOOLS: PDFTool[] = [
  {
    id: 'id-merge',
    name: 'Aadhaar / Any ID Card',
    description: 'Merge front & back of Aadhaar, PAN, Voter or any ID card onto a single A4 page.',
  ...
  },
  {
    id: 'scan-to-pdf',
    name: 'Scan to PDF',
    description: 'Use your camera or native scanner to scan documents directly into a PDF.',
    category: ToolCategory.CONVERT,
    icon: 'fa-camera',
    path: '/scan',
    color: '#0d9488',
...
export const BLOG_POSTS = [
  {
    ...
    content: `
      ...
      <p>The good news is that technology has caught up. Modern browsers are powerful enough to run complex software locally. Tools like <strong>PDFVio</strong> leverage this power to bring professional-grade PDF processing directly to your browser's memory.</p>
      <h2>Conclusion</h2>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Conclusion</h2>
      <p>High-quality compression isn't magic—it's math. Using tools like PDFVio's Compress PDF allows you to apply these rules locally and safely.</p>
    `
  },
  {
    ...
    content: `
      ...
      <p>PDFVio uses a "Virtual Width" rendering technique to simulate an A4 page within your browser, capturing every margin and line break exactly as Word intended.</p>
      <h2>Conclusion</h2>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Your ID card contains your most sensitive data. <strong>Never</strong> upload a photo of your ID to a cloud-based merger. Use PDFVio's ID Card Merge tool to handle the process entirely on your device.</p>
      <h2>Conclusion</h2>
  ...
  },
  {
    ...
    content: `
      ...
      <p>You don't need to be perfectly parallel. Modern tools like <strong>jscanify</strong> (used in PDFVio) can automatically detect corners and correct the perspective, making the document look as if it was scanned on a flatbed.</p>
      <h2>Conclusion</h2>
